...
export const SERVICES = [
  { id: 'termite', title: 'Termite Control', icon: '🏗️' },
  { id: 'cockroach', title: 'Cockroach Management', icon: '🪳' },
  { id: 'rodent', title: 'Rodent Control', icon: '🐀' },
  { id: 'mosquito', title: 'Mosquito Control', icon: '🦟' },
  { id: 'bedbug', title: 'Bed Bug Treatment', icon: '🛌' },
  { id: 'general', title: 'General Pest Control', icon: '🛡️' }
];
