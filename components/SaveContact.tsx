...
END:VCARD`;
  ...
  return (
    <div className="px-8 mb-14">
      <button
        onClick={handleSave}
        className="w-full bg-[#0F172A] text-white font-bold py-4 rounded-2xl flex items-center justify-center space-x-3 transition-all active:scale-[0.98] shadow-lg"
      >
